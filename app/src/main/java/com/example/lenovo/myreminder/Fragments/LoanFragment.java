...
import com.example.lenovo.myreminder.Signin;
import com.example.lenovo.myreminder.alarm_manager.DailyAlarm;
import com.example.lenovo.myreminder.alarm_manager.LoanAlarm;
        ...
        add.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                try {
                    ...
                    intent.putExtra("PersonName", person.getText().toString());
                    intent.putExtra("Amount", amount.getText().toString());
                    intent.putExtra("LoanType", type.getText().toString());
